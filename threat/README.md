...
| blocklist_de | 24145 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1680 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 1202 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 30178
- **Raw total (sum of all sources):** 44408
- **Slots saved vs. running them separately:** 14230
- **Last updated UTC:** 2026-07-13 07:45:55
