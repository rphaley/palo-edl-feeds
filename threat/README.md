...
| blocklist_de | 23415 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1676 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 1543 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 28954
- **Raw total (sum of all sources):** 44024
- **Slots saved vs. running them separately:** 15070
- **Last updated UTC:** 2026-07-14 06:31:50
