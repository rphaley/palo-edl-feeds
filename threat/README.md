...
| blocklist_de | 23593 | `https://opendbl.net/lists/blocklistde-all.list` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 29509
- **Raw total (sum of all sources):** 40648
- **Slots saved vs. running them separately:** 11139
- **Last updated UTC:** 2026-05-12 21:54:56
