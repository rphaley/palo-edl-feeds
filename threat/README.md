...
| blocklist_de | 24260 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1668 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 3507 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 30850
- **Raw total (sum of all sources):** 46735
- **Slots saved vs. running them separately:** 15885
- **Last updated UTC:** 2026-07-22 07:05:20
