...
| blocklist_de | 23911 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1705 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 1558 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 30774
- **Raw total (sum of all sources):** 44457
- **Slots saved vs. running them separately:** 13683
- **Last updated UTC:** 2026-08-31 10:59:43
