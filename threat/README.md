...
| emerging_threats_compromised | 533 | `https://rules.emergingthreats.net/blockrules/compromised-ips.txt` |
| cins_score | 15000 | `https://cinsscore.com/list/ci-badguys.txt` |
| blocklist_de | 28673 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1709 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 250 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 34521
- **Raw total (sum of all sources):** 47914
- **Slots saved vs. running them separately:** 13393
- **Last updated UTC:** 2026-09-02 08:52:46
