...
| blocklist_de | 24834 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1705 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 1297 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 31504
- **Raw total (sum of all sources):** 45119
- **Slots saved vs. running them separately:** 13615
- **Last updated UTC:** 2026-08-30 10:00:52
