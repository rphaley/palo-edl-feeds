...
| blocklist_de | 27240 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1631 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 383 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 31281
- **Raw total (sum of all sources):** 46441
- **Slots saved vs. running them separately:** 15160
- **Last updated UTC:** 2026-05-24 07:35:21
