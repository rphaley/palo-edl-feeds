...
| blocklist_de | 21380 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1697 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 1805 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 26694
- **Raw total (sum of all sources):** 42265
- **Slots saved vs. running them separately:** 15571
- **Last updated UTC:** 2026-06-28 08:01:09
