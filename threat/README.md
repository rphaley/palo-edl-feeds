...
| emerging_threats_compromised | 669 | `https://rules.emergingthreats.net/blockrules/compromised-ips.txt` |
| cins_score | 15000 | `https://cinsscore.com/list/ci-badguys.txt` |
| blocklist_de | 23331 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1709 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 6160 | `https://www.binarydefense.com/banlist.txt` |
| waf_offenders (local) | 157 | `waf/waf-offenders.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 30243
- **Raw total (sum of all sources):** 48778
- **Slots saved vs. running them separately:** 18535
- **Last updated UTC:** 2026-09-26 09:26:07
