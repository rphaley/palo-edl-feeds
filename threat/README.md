...
| emerging_threats_compromised | 651 | `https://rules.emergingthreats.net/blockrules/compromised-ips.txt` |
| cins_score | 15000 | `https://cinsscore.com/list/ci-badguys.txt` |
| blocklist_de | 32203 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1680 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 665 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 37659
- **Raw total (sum of all sources):** 51923
- **Slots saved vs. running them separately:** 14264
- **Last updated UTC:** 2026-07-09 07:57:30
