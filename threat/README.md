...
| ------ | --------- | --- |
| emerging_threats | 1745 | `https://rules.emergingthreats.net/fwrules/emerging-Block-IPs.txt` |
...
| blocklist_de | 25127 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1724 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 4148 | `https://www.binarydefense.com/banlist.txt` |
| waf_offenders (local) | 221 | `waf/waf-offenders.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 32170
- **Raw total (sum of all sources):** 48573
- **Slots saved vs. running them separately:** 16403
- **Last updated UTC:** 2026-09-16 09:23:06
