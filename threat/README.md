...
| blocklist_de | 25218 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1715 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 5363 | `https://www.binarydefense.com/banlist.txt` |
| waf_offenders (local) | 169 | `waf/waf-offenders.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 31371
- **Raw total (sum of all sources):** 49908
- **Slots saved vs. running them separately:** 18537
- **Last updated UTC:** 2026-09-22 09:23:26
