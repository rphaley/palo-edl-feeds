...
| blocklist_de | 21291 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1705 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 6340 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 29088
- **Raw total (sum of all sources):** 46690
- **Slots saved vs. running them separately:** 17602
- **Last updated UTC:** 2026-06-20 08:01:23
