...
| blocklist_de | 22852 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1642 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 3357 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 30587
- **Raw total (sum of all sources):** 45060
- **Slots saved vs. running them separately:** 14473
- **Last updated UTC:** 2026-06-08 09:10:40
