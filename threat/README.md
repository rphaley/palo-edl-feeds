...
| ------ | --------- | --- |
| emerging_threats | 1688 | `https://rules.emergingthreats.net/fwrules/emerging-Block-IPs.txt` |
...
| blocklist_de | 28162 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1666 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 1512 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 34231
- **Raw total (sum of all sources):** 48628
- **Slots saved vs. running them separately:** 14397
- **Last updated UTC:** 2026-07-30 07:06:51
