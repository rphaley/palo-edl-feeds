...
| blocklist_de | 29229 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1706 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 715 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 34593
- **Raw total (sum of all sources):** 48940
- **Slots saved vs. running them separately:** 14347
- **Last updated UTC:** 2026-09-03 09:01:51
