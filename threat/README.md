...
| blocklist_de | 24615 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1669 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 473 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 30088
- **Raw total (sum of all sources):** 44054
- **Slots saved vs. running them separately:** 13966
- **Last updated UTC:** 2026-07-26 07:10:30
