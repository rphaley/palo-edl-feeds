...
| blocklist_de | 27769 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1722 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 3373 | `https://www.binarydefense.com/banlist.txt` |
...
- **Final entry count:** 34710
- **Raw total (sum of all sources):** 50454
- **Slots saved vs. running them separately:** 15744
- **Last updated UTC:** 2026-09-13 09:37:56
