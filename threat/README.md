...
| blocklist_de | 26878 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1680 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 4098 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 33987
- **Raw total (sum of all sources):** 50023
- **Slots saved vs. running them separately:** 16036
- **Last updated UTC:** 2026-07-07 07:56:30
