...
| blocklist_de | 25943 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1669 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 4119 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 31992
- **Raw total (sum of all sources):** 49028
- **Slots saved vs. running them separately:** 17036
- **Last updated UTC:** 2026-07-25 06:34:31
