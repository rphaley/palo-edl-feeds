...
| blocklist_de | 23481 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1686 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 1161 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 28937
- **Raw total (sum of all sources):** 43607
- **Slots saved vs. running them separately:** 14670
- **Last updated UTC:** 2026-08-17 05:04:02
