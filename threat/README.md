...
| blocklist_de | 22066 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1663 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 771 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 28588
- **Raw total (sum of all sources):** 41797
- **Slots saved vs. running them separately:** 13209
- **Last updated UTC:** 2026-07-27 07:58:50
