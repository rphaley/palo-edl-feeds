...
| blocklist_de | 29875 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1680 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 578 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 35005
- **Raw total (sum of all sources):** 49514
- **Slots saved vs. running them separately:** 14509
- **Last updated UTC:** 2026-07-11 06:31:23
