...
| blocklist_de | 24604 | `https://opendbl.net/lists/blocklistde-all.list` |
| spamhaus_drop | 1681 | `https://www.spamhaus.org/drop/drop.txt` |
| dshield_block | 20 | `https://isc.sans.edu/block.txt` |
| binary_defense | 3048 | `https://www.binarydefense.com/banlist.txt` |

## Output

- **Combined EDL URL:** `https://raw.githubusercontent.com/rphaley/palo-edl-feeds/main/threat/combined-threat-ips.txt`
- **Final entry count:** 31098
- **Raw total (sum of all sources):** 46687
- **Slots saved vs. running them separately:** 15589
- **Last updated UTC:** 2026-07-03 07:44:06
